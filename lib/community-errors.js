module.exports = function (errors) {
  ...
  errors.create({
   ...
   errors.create({
    behavior: 'OTHER',
    name: 'CommunityMessagesCreate',
    code: 60111,
    status: 500,
    defaultMessage: 'Cannot create message'
   })

   errors.create({
    behavior: 'OTHER',
    name: 'CommunityMessagesCreateValidationError',
    code: 60112,
    status: 400,
    defaultMessage: 'Cannot create message - validation error'
   })
