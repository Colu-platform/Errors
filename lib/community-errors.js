module.exports = function (errors) {
  ...
  errors.create({
    ...
    code: 80024,
    status: 400,
    defaultMessage: 'Account Transaction Activity Exceeded',
    defaultResponse: 'Account Transaction Activity Exceeded'
  })

  errors.create({
    behavior: 'OTHER',
    name: 'RecipientKYCFailed',
    code: 80025,
    status: 400,
    defaultMessage: 'Recipient KYC Failed',
    defaultResponse: 'Recipient KYC Failed'
  })

  errors.create({
    behavior: 'OTHER',
    name: 'SenderKYCFailed',
    code: 80026,
    status: 400,
    defaultMessage: 'Sender KYC Failed',
    defaultResponse: 'Sender KYC Failed'
  })
}
